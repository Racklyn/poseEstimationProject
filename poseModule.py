...
class poseDetector():
    ...
    def findAngle(self, img, p1, p2, p3, draw=True):
        ...
        # Get landmarks
        x1, y1 = self.lmList[p1][1:] # [id, x, y] => pegando apenas x e y
        ...
        if draw:
            ...
            cv2.circle(img, (x1, y1), 10, (0, 180, 255), cv2.FILLED)
            cv2.circle(img, (x1, y1), 15, (0, 180, 255), 2)

            cv2.circle(img, (x2, y2), 10, (0, 180, 255), cv2.FILLED)
            cv2.circle(img, (x2, y2), 15, (0, 180, 255), 2)

            cv2.circle(img, (x3, y3), 10, (0, 180, 255), cv2.FILLED)
            cv2.circle(img, (x3, y3), 15, (0, 180, 255), 2)
